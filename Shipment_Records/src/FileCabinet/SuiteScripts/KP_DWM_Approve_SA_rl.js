...
define(['N/record','N/search', 'N/ui/serverWidget', 'N/url', 'N/redirect', 'N/format', 'N/https','N/runtime','N/task'], function(record,search, serverWidget, url, redirect, format, https, runtime, task) {
    return{
        ...
        //log.debug('requestBody',requestBody.ids)
        ...
        if(action == 'approve'){
            //var entity = script.getParameter({name: 'custscript_entity_record'});
            ...
            if(srIds){
                //log.debug('first if', 'Restlet Script Executed');
                //for(var x=0;x<soIds.length;x++){
                    ...
                    //var isQueue = srRec.custbody_onqueue;
                        
                    if(!isInv){
                        //log.debug('If is Inv', isInv);
            ...
            if(soIds.length>0){
                    for(var x=0;x<soIds.length;x++){
                        ...
                        //if(isApply == true && srRec.custbody_owned_by_sa[0].value == myUser.id){
                            hasApply = 1
                            ...
                            /*console.log(srRec.custbody_invoice)
                            console.log(srRec.tranid)
                            console.log(srRec.entity)
                            console.log(srRec.custbody_billtoaccount)
                            console.log(srRec.trandate)
                            console.log(srRec.custbody_servicelevel)
                            console.log(srRec.custbody_origin)
                            console.log(srRec.custbody_destination)
                            console.log(srRec.custbody_shipper_address)
                            console.log(srRec.custbody_consignee_address)
                            console.log(srRec.custbody_shipmentstatus)
                            console.log(srRec.custbody_pallets)*/
                            /*log.debug('custbody_pickupwaittime',srRec.custbody_pickupwaittime)
                            log.debug('custbody_deliverywaittime',srRec.custbody_deliverywaittime)
                            log.debug('custbody_actualweight',srRec.custbody_actualweight)
                            log.debug('custbody_dim_weight',srRec.custbody_dim_weight)
                            log.debug('custbody_pickupdate',srRec.custbody_pickupdate)
                            log.debug('custbody_deliverdate',srRec.custbody_deliverdate)
                            log.debug('custbody_pickuptime',srRec.custbody_pickuptime)
                            log.debug('custbody_deliverytime',srRec.custbody_deliverytime)*/
                            ...
                            if(isInv == true){
                                ...
                                /*var entityVal = soRec.getValue({
                                    fieldId: 'entity'
                                })*/

                                //log.debug('Here else',isInv)
                                ...
                                if(srRec.custbody_billtoaccount.length != 0){
                                    ...
                                    //alert('Shipment Record(s) '+srRec.tranid+" Bill to Code is mandatory to Calculate")
                                ...
                                if(srRec.trandate){
                                    ...
                                    //alert('Shipment Record(s) '+srRec.tranid+"HAWB DATE is mandatory to Calculate")
                                ...
                                if(srRec.custbody_servicelevel.length != 0){
                                    ...
                                    //alert('Shipment Record(s) '+srRec.tranid+"Service Level is mandatory to Calculate")
                                ...
                                //log.debug('before format',hawbDate)
                                var hawbDateOnly = hawbDate;
                                //log.debug('after format',hawbDate)
                                ...
                                if(shipStatus == 1){
                                    ...
                                    /*log.debug(billAcc)
                                    log.debug(SL)
                                    log.debug(hawbDateOnly)
                                    log.debug(origin)
                                    log.debug(dest)
                                    log.debug(shipperAddress)
                                    log.debug(consigneeAddress)
                                    log.debug('Here Ship Status',shipStatus)*/
                                    ...
                                    discSearchPage.data.forEach(function (result) {
                                        ...
                                        /*currRecObj.setValue({
                                            fieldId: 'custpage_form_field',
                                            value: billtoCode +','+ customer +','+ valueBy +','+ value
                                        })*/
                                        discountFieldArr.push({
                                            "id" : internalId,
                                   ...
                                   // log.debug('discountVal',discountVal)
                                    ...
                                    totalArr.push(sameDayDelVal)
                                        ...
                                        /*console.log('freightVal',freightVal)
                                        console.log('discountVal',discountVal)
                                        console.log('fuelVal',fuelVal)
                                        console.log('waitTimePUVal',waitTimePUVal)
                                        console.log('waitTimeDelVal',waitTimeDelVal)
                                        console.log('sameDayDelVal',sameDayDelVal)
                                        console.log('AHPUVal',AHPUVal)
                                        console.log('AHDelVal',AHDelVal)
                                        console.log('storageVal',storageVal)
                                        console.log('manpowerVal',manpowerVal)
                                        console.log('smartPalVal',smartPalVal)
                                        console.log('CFCVal',CFCVal)
                                        console.log('FAGVal',FAGVal)*/

...
function(runtime, currentRecord, search, record, url, dialog, format, https) {
    ...
    const ARR_FIELDIDS = [
        ...
        'custpage_cancelled_order_origin'
    ]

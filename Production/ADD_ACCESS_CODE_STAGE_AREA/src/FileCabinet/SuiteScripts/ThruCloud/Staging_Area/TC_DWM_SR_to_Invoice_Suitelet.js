    ...
    define(['N/search', 'N/ui/serverWidget', 'N/url', 'N/redirect', 'N/record','N/https','N/runtime','N/task'], function(search, serverWidget, url, redirect, record, https,runtime, task) {
        ...
        function onRequest(context) {
            if (context.request.method === 'GET') {
                ...
                soBodyfield.updateDisplayType({displayType: 'HIDDEN'});
                ...
                var myUser = runtime.getCurrentUser();
                    ...
                    soId.updateDisplayType({displayType: 'HIDDEN'});
                    ...
                    ownerId.updateDisplayType({displayType: 'HIDDEN'});
                ...
                sublist.addField({
                    ...
                    var fldRedelivery = sublist.addField({
                        id: 'custpage_redelivery',
                        type: serverWidget.FieldType.TEXT,
                        label: 'Redelivery'
                    });
                    
                    fldRedelivery.updateDisplayType({
                        displayType: serverWidget.FieldDisplayType.ENTRY
                    });

                    var fldHazMatCharge = sublist.addField({
                        id: 'custpage_hazmat_charge',
                        type: serverWidget.FieldType.TEXT,
                        label: 'Haz-Mat Charge'
                    });
                    
                    fldHazMatCharge.updateDisplayType({
                        displayType: serverWidget.FieldDisplayType.ENTRY
                    });

                    var fldOverSizeCharge = sublist.addField({
                        id: 'custpage_over_size_charge',
                        type: serverWidget.FieldType.TEXT,
                        label: 'Over-Size Charge'
                    });
                    
                    fldOverSizeCharge.updateDisplayType({
                        displayType: serverWidget.FieldDisplayType.ENTRY
                    });

                    var fldPalletize = sublist.addField({
                        id: 'custpage_palletize',
                        type: serverWidget.FieldType.TEXT,
                        label: 'Palletize'
                    });
                    
                    fldPalletize.updateDisplayType({
                        displayType: serverWidget.FieldDisplayType.ENTRY
                    });

                    var fldBeyondPoint = sublist.addField({
                        id: 'custpage_beyond_point',
                        type: serverWidget.FieldType.TEXT,
                        label: 'Beyond Point'
                    });
                    
                    fldBeyondPoint.updateDisplayType({
                        displayType: serverWidget.FieldDisplayType.ENTRY
                    });
                            ...
                            if(result.id){
                                ...
                                var soRecField = search.lookupFields({
                                    ...
                                    columns: [
                                        ...
                                        'custbody_redelivery',
                                        'custbody_hazmat_charge',
                                        'custbody_oversize_charge',
                                        'custbody_palletize',
                                        'custbody_beyond_point',
                                    ]
                                });
                                ...
                                if(soRecField.custbody_redelivery){
                                    sublist.setSublistValue({
                                        id: 'custpage_redelivery',
                                        line: j,
                                        value: soRecField.custbody_redelivery
                                    });
                                }

                                if(soRecField.custbody_hazmat_charge){
                                    sublist.setSublistValue({
                                        id: 'custpage_hazmat_charge',
                                        line: j,
                                        value: soRecField.custbody_hazmat_charge
                                    });
                                }

                                if(soRecField.custbody_oversize_charge){
                                    sublist.setSublistValue({
                                        id: 'custpage_over_size_charge',
                                        line: j,
                                        value: soRecField.custbody_oversize_charge
                                    });
                                }

                                if(soRecField.custbody_palletize){
                                    sublist.setSublistValue({
                                        id: 'custpage_palletize',
                                        line: j,
                                        value: soRecField.custbody_palletize
                                    });
                                }

                                if(soRecField.custbody_beyond_point){
                                    sublist.setSublistValue({
                                        id: 'custpage_beyond_point',
                                        line: j,
                                        value: soRecField.custbody_beyond_point
                                    });
                                }

                    ...
                    if(!isInv){
                        ...
                        var soIdRec = record.submitFields({
                            ...
                            values: {
                                ...
                                custbody_redelivery : srRec.custbody_redelivery,
                                custbody_hazmat_charge : srRec.custbody_hazmat_charge,
                                custbody_oversize_charge : srRec.custbody_oversize_charge,
                                custbody_palletize : srRec.custbody_palletize,
                                custbody_beyond_point : srRec.custbody_beyond_point,
